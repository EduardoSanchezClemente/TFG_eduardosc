...
extern int16_t lis3dh_i2c_port_id;
...
u8_t LIS3DH_ReadReg(u8_t Reg, u8_t* Data) {
	port_state_t i2c_state = i2c1_driver->i2c_funcs.i2c_port_get_state(i2c1_driver, lis3dh_i2c_port_id);
	if(i2c_state != DRIVER_PORT_CLOSED){
		i2c1_driver->i2c_funcs.i2c_read_reg(i2c1_driver, lis3dh_i2c_port_id, Reg, 1,(uint8_t*) Data, 1);
	}
//  HAL_I2C_Mem_Read(&hi2c1, LIS3DH_MEMS_I2C_ADDRESS, Reg, I2C_MEMADD_SIZE_8BIT, Data, 1, 500);
...
u8_t LIS3DH_WriteReg(u8_t WriteAddr, u8_t Data) {
	...
	port_state_t i2c_state = i2c1_driver->i2c_funcs.i2c_port_get_state(i2c1_driver, lis3dh_i2c_port_id);
	if(i2c_state != DRIVER_PORT_CLOSED){
		i2c1_driver->i2c_funcs.i2c_write_reg(i2c1_driver, lis3dh_i2c_port_id, WriteAddr, 1,(uint8_t*) &Data, 1);
	}
//  HAL_I2C_Mem_Write(&hi2c1, LIS3DH_MEMS_I2C_ADDRESS, WriteAddr, 1, &Data, 1, 500);
