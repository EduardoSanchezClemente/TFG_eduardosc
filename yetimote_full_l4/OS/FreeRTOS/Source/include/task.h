...
//RRZ Function declaration
void set_bat(float32_t bat);
void set_rssi(float32_t rssi);
void set_net(float32_t net);
void set_mult(float32_t mult);
void enable_adapt_duty_cycle(void);
void disable_adapt_duty_cycle(void);
...
//RRZ
BaseType_t ADAPT_SCH_TaskIncrementTick( void ) PRIVILEGED_FUNCTION;
/*
